...
if __name__ == "__main__":
    ...
    # 数据集的根目录(coco2017根目录)
    parser.add_argument('--data-path', default='E:\\AC-FPN\\data\\coco2017', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights', default='./multi_train/model_25.pth', type=str, help='training weights')
