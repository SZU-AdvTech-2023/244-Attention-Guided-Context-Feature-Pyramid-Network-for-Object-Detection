...
CKimg_dir = 'E:/AC-FPN/data/coco2017_voc/images'
CKanno_dir = 'E:/AC-FPN/data/coco2017_voc/annotations'
...
def main():
    base_dir = 'E:/AC-FPN/data/coco2017_voc'  # step1 这里是一个新的文件夹，存放转换后的图片和标注
    image_dir = os.path.join(base_dir, 'images')  # 在上述文件夹中生成images，annotations两个子文件夹
    anno_dir = os.path.join(base_dir, 'annotations')
    mkr(image_dir)
    mkr(anno_dir)
    origin_image_dir = 'E:/AC-FPN/data/coco2017'  # step 2原始的coco的图像存放位置
    origin_anno_dir = 'E:/AC-FPN/data/coco2017/annotations'  # step 3 原始的coco的标注存放位置
