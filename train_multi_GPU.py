...
from backbone import resnet50_fpn_backbone, resnet101_fpn_backbone
...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(norm_layer=torch.nn.BatchNorm2d,
                                      trainable_layers=4)
    #backbone = resnet101_fpn_backbone(norm_layer=torch.nn.BatchNorm2d,
    #                                 trainable_layers=4)
    ...
    if load_pretrain_weights:
        ...
        weights_dict = torch.load("E:\\AC-FPN\\data\\fasterrcnn_resnet50_fpn_coco.pth", map_location='cpu')
...
if __name__ == "__main__":
    ...
    # 训练文件的根目录(coco2017)
    parser.add_argument('--data-path', default='E:/AC-FPN/data/coco2017', help='dataset')
    # 训练设备类型
    ...
    # 学习率，这个需要根据gpu的数量以及ds进行设置0.02 / 8 * num_GPU
